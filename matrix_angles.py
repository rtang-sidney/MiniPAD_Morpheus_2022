...
def polarisation2angles(incoming_axis, outgoing_axis, delta_i, delta_f):
    ...
    :param delta_i: angle from ki-vactor to Q-vector
    :param delta_f: angle from Q-vector to kf-vector
    ...
    alpha_i, beta_i = _angles_incoming(axis=incoming_axis, delta_i=delta_i)
    alpha_f, beta_f = _angles_outgoing(axis=outgoing_axis, delta_f=delta_f)
    # alpha_f = alpha_f
    # beta_f = beta_f
